...
<div class="x-body">
    ...
    <table class="layui-table" lay-skin="line" style="border: none;">
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo url('Collect/detail'); ?>?id=<?php echo $vo['id']; ?>"><button class="layui-btn" data-type="reload">查看详情</button></a>
                <a href="javascript:;" onclick="coll('<?php echo $vo['id']; ?>')"><button class="layui-btn" data-type="reload">取消收藏</button></a>
            </td>
        </tr>
...
<script type="text/javascript">
    ...
    function coll(id){
        $.ajax({
            url:"<?php echo url('Collect/clearCollect'); ?>?tid="+id,
            type:"post",
            success:function(re){
                if(re.code == 1){
