<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:50:"F:\wamp\www\yajie/app/admin\view\category\add.html";i:1509175487;s:49:"F:\wamp\www\yajie/app/admin\view\common\head.html";i:1510307286;s:49:"F:\wamp\www\yajie/app/admin\view\common\foot.html";i:1507509539;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main fadeInUp animated">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="url" value="" placeholder="请输入栏目链接地址" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                <?php $lang=$lang; if($lang==1){ ?>
                <a href="<?php echo url('index'); ?>" class="layui-btn layui-btn-primary"><?php echo lang('back'); ?></a>
                <?php }elseif($lang==2){ ?>
                <a href="<?php echo url('index2'); ?>" class="layui-btn layui-btn-primary"><?php echo lang('back'); ?></a>
                <?php } ?>
            </div>
        </div>
    </form>
...
<script>
    ...
    layui.use(['form','upload'], function () {
        ...
        form.on('submit(submit)', function (data) {
            ...
            $.post("<?php echo url('insert'); ?>?lang="+lang, data.field, function (res) {
                layer.close(loading);
                if (res.code > 0) {
