<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"F:\wamp\www\yajie/app/admin\view\module\fieldAddType.html";i:1507509540;}*/ ?>
<style>
...
<table class="typeTable" cellpadding="2" cellspacing="1" width="100%">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="radio" name="setup[multiple]" value="0" title="多选列表框">
        </td>
    </tr>
    <tr>
        <td>字段类型</td>
