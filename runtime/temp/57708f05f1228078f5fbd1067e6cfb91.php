<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"F:\wamp\www\yajie/app/admin\view\login\index.html";i:1511182245;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div style="margin-top: 10px">
        <img src="__ADMIN__/images/bgimg.jpg" alt="" style="width: 100%;height: 650px;" />
    </div>
    <div class="login">
