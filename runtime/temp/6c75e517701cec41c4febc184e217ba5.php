<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"F:\wamp\www\yajie/app/admin\view\train\index.html";i:1511183498;s:49:"F:\wamp\www\yajie/app/admin\view\common\head.html";i:1510307286;s:49:"F:\wamp\www\yajie/app/admin\view\common\foot.html";i:1507509539;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main layui-anim layui-anim-upbit">
    ...
    <div class="demoTable">
        <div class="layui-inline">
            <input class="layui-input" name="key" id="key" placeholder="<?php echo lang('pleaseEnter'); ?>姓名/标题">
        </div>
...
<script type="text/html" id="action">
    <a href="<?php echo url('detail'); ?>?id={{d.id}}&name={{d.nikename}}" class="layui-btn layui-btn-mini">查看详情</a>
    ...
    layui.use('table', function() {
        ...
        var tableIn = table.render({
            ...
            cols: [[
                ...
                {field: 'nikename',  title: '姓名', width: 180},
                {field: 'score',  title: '得分', width: 180},
