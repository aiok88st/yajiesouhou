<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"F:\wamp\www\yajie/app/user\view\distrit\index.html";i:1511170853;s:50:"F:\wamp\www\yajie/app/user\view\common\header.html";i:1511150016;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
            <input type="text" name="key"  placeholder="请输入姓名/电话/账号" autocomplete="off" class="layui-input">
