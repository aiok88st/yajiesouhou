...
-- ----------------------------
INSERT INTO `clt_auth_rule` VALUES ('1', 'System', '系统设置', '1', '1', '0', 'icon-cogs', '', '0', '99', '1446535750', '1', '0');
INSERT INTO `clt_auth_rule` VALUES ('2', 'System/system', '常用设置', '1', '1', '0', '', '', '1', '1', '1446535789', '1', '0');
INSERT INTO `clt_auth_rule` VALUES ('302', 'repair/index', '报修申请管理', '1', '1', '0', '', '', '294', '1', '1511145025', null, '1');
...
INSERT INTO `clt_auth_rule` VALUES ('15', 'Auth/adminList', '系统管理', '1', '1', '0', 'icon-lifebuoy', '', '0', '9', '1446535750', '1', '1');
...
INSERT INTO `clt_auth_rule` VALUES ('170', 'Ad/add', '操作-添加', '1', '1', '0', '', '', '45', '1', '1461550835', '1', '1');
INSERT INTO `clt_auth_rule` VALUES ('171', 'Ad/edit', '操作-修改', '1', '1', '0', '', '', '45', '2', '1461550835', '1', '1');
INSERT INTO `clt_auth_rule` VALUES ('173', 'Ad/del', '操作-删除', '1', '1', '0', '', '', '45', '5', '1461550835', '1', '1');
INSERT INTO `clt_auth_rule` VALUES ('174', 'Ad/adOrder', '操作-排序', '1', '1', '0', '', '', '45', '4', '1461550835', '1', '1');
INSERT INTO `clt_auth_rule` VALUES ('175', 'Ad/editState', '操作-状态', '1', '1', '0', '', '', '45', '3', '1461550835', '1', '1');
...
INSERT INTO `clt_auth_rule` VALUES ('293', '/yajie/admin/User/index', '会员管理', '1', '1', '0', 'icon-users', '', '0', '3', '1509848831', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('294', 'Service/index', '售后管理', '1', '1', '0', 'icon-list', '', '0', '0', '1509849210', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('296', 'Train', '培训管理', '1', '1', '0', 'icon-ungroup', '', '0', '2', '1510037240', null, '1');
...
CREATE TABLE `clt_client` (
  ...
  `open_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `clt_field` VALUES ('271', '23', 'images', '视频图片', '', '1', '0', '0', 'defaul', '', 'images', 'image', 'array (\n  \'upload_allowext\' => \'jpg|jpeg|gif|png\',\n)', '0', '', '4', '1', '0');
...
CREATE TABLE `clt_order` (
  ...
  `type` tinyint(1) NOT NULL COMMENT '1:快递到维修点，2:上门服务',
  `name` char(100) CHARACTER SET utf8 NOT NULL,
  `phone` char(100) NOT NULL,
  `province` int(11) NOT NULL,
  `city` int(11) NOT NULL,
  `zone` int(11) NOT NULL,
  `addra` varchar(255) NOT NULL,
  `msg` text CHARACTER SET utf8 NOT NULL,
  `images` text,
  `status` tinyint(1) DEFAULT NULL COMMENT '0:审核中，-1:审核不通过，1:待维修，2，维修中，3，已完成，4:已关闭，5:已取消',
  `audit` text CHARACTER SET utf8 COMMENT '审核留言',
  `c_logistics` char(50) DEFAULT NULL COMMENT '物流公司(客户)',
  `c_logistics_number` char(100) DEFAULT NULL COMMENT '物流单号',
  `user_id` int(11) DEFAULT NULL COMMENT '经销商ID',
  `u_logistics` char(100) DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `clt_order_log`;
CREATE TABLE `clt_order_log` (
  `id` int(11) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `order_id` int(11) NOT NULL,
  `admin_type` tinyint(1) DEFAULT '1' COMMENT '1:公司总部，2:经销商',
...
-- ----------------------------
INSERT INTO `clt_order_log` VALUES ('00000000001', '6', '1', '1', '审核不通过，原因：请认真填写问题描述', '2017-11-20 20:04:56');
INSERT INTO `clt_order_log` VALUES ('00000000002', '6', '1', '1', '审核不通过，原因：请认真填写问题描述', '2017-11-20 20:07:13');
INSERT INTO `clt_order_log` VALUES ('00000000003', '6', '1', '1', '审核不通过，原因：就啊沙发沙发沙发', '2017-11-20 20:09:51');
...
-- ----------------------------
DROP TABLE IF EXISTS `clt_product_img`;
CREATE TABLE `clt_product_img` (
  `id` int(11) unsigned zerofill NOT NULL AUTO_INCREMENT,
